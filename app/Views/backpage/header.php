...
<head>
    ...
    <title>E-Compram Dashboard</title>
    <link
    ...
    ></script>
    <script src="<?= base_url('assets/js/charts-lines.js') ?>"></script>
    <script src="<?= base_url('assets/js/charts-pie.js') ?>"></script>
</head>
<body>
<div
